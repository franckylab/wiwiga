...
class ApiEndpoints {
  ...
  // Wiga virtuels — seuls achat, cadeau ami et promos
  ...
  static const String joinGame =
      '/api/games'; // + /:game_id/join {bet_amount, rule_type}
  static const String leaveQueue = '/api/games'; // + /:game_id/queue DELETE
  static const String queueStatus =
      '/api/games'; // + /:game_id/queue/status GET
  ...
  static const String activeGame =
      '/api/games/me/active'; // GET partie active pour redirection auto
  static const String gameState = '/api/games'; // + /:game_id/state
  // Revanche opt-out (fin de partie) + sortie d'interface
  static const String rematchPropose = 'rematch/propose';
  static const String rematchRespond = 'rematch/respond';
  static const String rematchStart = 'rematch/start';
  static const String rematchCancel = 'rematch/cancel';
  static const String matchLeave = 'leave';
  ...
  static const String responsibleGamingLimits =
      '/api/responsible-gaming/limits';
  ...
  static const String adminSecurityFailedAuths =
      '/api/admin/security/failed-auths';
  static const String adminSecurityRateLimits =
      '/api/admin/security/rate-limits';
  static const String adminSecurityIpWhitelist =
      '/api/admin/security/ip-whitelist';

  // Admin - Jeu responsable
  static const String adminResponsibleGamingOverview =
      '/api/admin/responsible-gaming/overview';
  static const String adminResponsibleGamingSelfExclusions =
      '/api/admin/responsible-gaming/self-exclusions';
  static const String adminResponsibleGamingRiskIndicators =
      '/api/admin/responsible-gaming/risk-indicators';
  ...
  static const String adminExportTransactions =
  ...
  static const String adminCrmPlayerSummary =
      '/api/admin/crm/players'; // + /:id/summary
  static const String adminCrmPlayerNotes =
      '/api/admin/crm/players'; // + /:id/notes
  static const String adminCrmVipTier =
      '/api/admin/crm/players'; // + /:id/vip-tier

  // Admin - Réconciliation
  static const String adminReconciliationDaily =
      '/api/admin/reconciliation/daily';
  static const String adminReconciliationDiscrepancies =
      '/api/admin/reconciliation/discrepancies';
  static const String adminReconciliationCommissions =
      '/api/admin/reconciliation/commissions';
  static const String adminReconciliationBalance =
      '/api/admin/reconciliation/balance';

  // Admin - Settings
  static const String adminSettings = '/api/admin/settings';
  static const String adminSettingsCategory =
      '/api/admin/settings/category'; // + /:category

  // Admin - Impersonation
  static const String adminImpersonateStart =
      '/api/admin/impersonate'; // + /:user_id/start
  ...
  static String adminAlertResolve(String alertId) =>
  ...
  static const String adminAnalyticsMonetaryFlow =
      '/api/admin/analytics/monetary-flow';
  static const String adminAnalyticsWealthDistribution =
      '/api/admin/analytics/wealth-distribution';
  static const String adminAnalyticsConversionFunnel =
  ...
  static const String adminPlayerProgressionLevels =
      '/api/admin/player-progression/levels';
  static const String adminPlayerProgressionCalculate =
      '/api/admin/player-progression/calculate';
  ...
  static const String adminPlatformConfigHealth =
      '/api/admin/platform-config/health';
}
...
class WebSocketEvents {
  ...
  static const String diceRolling = 'dice_rolling';
  static const String diceRolled = 'dice_rolled';
  static const String turnChanged = 'turn_changed';
