        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection('2. Description du service',
                'WIWIGA est une plateforme de jeux de société en ligne, permettant aux utilisateurs de jouer à des jeux de dés et de cartes avec d\'autres joueurs. Le service inclut la gestion de comptes utilisateurs, de wiga virtuels, et de classements.',),
            const SizedBox(height: 16),
            ...
            const SizedBox(height: 16),
            _buildSection('4. Wiga virtuels',
                'Les wiga WIWIGA sont une monnaie virtuelle interne à l\'application. Ils n\'ont aucune valeur réelle et ne peuvent être échangés contre de l\'argent réel. Les wiga achetés sont non remboursables sauf dans les cas prévus par la loi.',),
            const SizedBox(height: 16),
            ...
            _buildSection('6. Responsabilité',
                'WIWIGA s\'efforce de fournir un service de qualité mais ne garantit pas une disponibilité continue ni l\'absence de bugs. Nous ne sommes pas responsables des pertes de wiga dues à des bugs ou à une utilisation abusive.',),
            const SizedBox(height: 16),
