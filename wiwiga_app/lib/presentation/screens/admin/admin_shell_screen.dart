...
class _AdminShellScreenState extends ConsumerState<AdminShellScreen>
  ...
  Widget _buildHeader(
    AdminAlertsState alertsState,
    AdminWsState wsState,
    bool isDesktop,
  ) {
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 4),
          Flexible(child: _buildProfileMenu()),
        ],
      ),
    );
  }
      ...
      child: Row(
        children: [
          Container(
            ...
            child:
                const Icon(Icons.grid_3x3, color: NeonColors.surface, size: 18),
          ),
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          buildDrawerSection(_navSections[index]),
                    ),
                  ),
                ],
              ),
...
class _AnimatedNavItemState extends State<_AnimatedNavItem>
  ...
  Widget build(BuildContext context) {
    final isActive = widget.currentPath == widget.item.path ||
        (widget.item.path != '/admin' &&
            widget.currentPath.startsWith(widget.item.path));
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: isActive
                      ? const Border(
                          left: BorderSide(color: NeonColors.primary, width: 3),
                        )
                      : null,
                ),
                child: Row(
...
class _WsIndicatorState extends State<_WsIndicator>
    with SingleTickerProviderStateMixin {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            color: color.withValues(
              alpha: widget.status == AdminWsStatus.connected
            ...
            boxShadow: widget.status == AdminWsStatus.connected
                ? [
                    BoxShadow(
                      color: color.withValues(alpha: _pulse.value * 0.4),
                      blurRadius: 4,
                      spreadRadius: 1,
                    ),
                  ]
